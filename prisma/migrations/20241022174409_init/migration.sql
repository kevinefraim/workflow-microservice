...
-- AddForeignKey
ALTER TABLE `Workflow_step` ADD CONSTRAINT `Workflow_step_workflow_interface_id_fkey` FOREIGN KEY (`workflow_interface_id`) REFERENCES `Workflow_interface`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
